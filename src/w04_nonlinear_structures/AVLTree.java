...
public class AVLTree<T extends Comparable<T>> extends BinarySearchTree<T> {
    ...
    // Update heights of subtrees at the same time
    ...
    // Balanced around a given node
    // Return the new node at that location
    ...
    // Rotate right around the subtree rooted at node
    // Return the new root
    ...
    // Rotate left around the subtree rooted at node
    // Return the new root
