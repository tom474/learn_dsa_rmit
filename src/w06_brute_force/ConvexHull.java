...
public class ConvexHull {
    ...
    /*
        ...
        This class, like all the Java 2D API, uses a default coordinate system called user space
    ...
    */
        ...
        for (int i = 0; i < sides; i++) {
            ...
            System.out.printf("Line (%.2f, %.2f) - (%.2f, %.2f) is on the convex hull",
