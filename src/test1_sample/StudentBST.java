...
public class StudentBST {
    ...
    // addStudent complexity = O(logN) (because the tree is balanced)
    ...
    // getStudentNode complexity = O(log(N))
    ...
    // nextStudent complexity = O(log(N))
    ...
    public Student nextStudent(Student student) {
        ...
        // If there is a right sub-tree => it is the left-most node in right sub-tree
        if (node.right != null) {
            node = node.right;
        ...
        // if Y exists, X must be the right-most child of the left subtree of Y
