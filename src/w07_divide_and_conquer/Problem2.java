package w07_divide_and_conquer;
...
class TreeNode {
    ...
    // Calculate tree height and check for balanced property at the same time
    public int height() {
        balanced = true;
    ...
    private int heightRecursive(TreeNode node) {
        ...
        if (Math.abs(hl - hr) > 1) {
            ...
            // For a tree to be balanced, the subtrees must be balanced, too
